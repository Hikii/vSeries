...
namespace vSupport_Series.Champions
{
    public class Thresh : Helper
    {
        ...
        private static void ThreshInterrupter(Obj_AI_Hero sender, Interrupter2.InterruptableTargetEventArgs args)
        {
        ...
        private static void AutoLantern()
        {
            ...
            foreach (var lantern in ObjectManager.Get<Obj_AI_Hero>().Where(x => x.IsAlly && !x.IsMe))
            {
