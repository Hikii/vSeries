...
namespace vSupport_Series.Core.Activator
{
    ...
    class ActivatorBase
    {
        ...
        public static void ActivatorBaseOnLoad()
        {
            ...
            Game.PrintChat("<font color='#ff3232'>vSupport Series: </font><font color='#d4d4d4'>Activator loaded!</font>");
        ...
        private static void ActivatorBaseOnProcessSpellCast(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
            ...
            if (sender is Obj_AI_Hero && args.Target.IsAlly && args.Target.Type == GameObjectType.obj_AI_Hero
                ...
                && sender.IsEnemy && sender.GetSpellDamage(((Obj_AI_Hero)args.Target), args.SData.Name) > ((Obj_AI_Hero)args.Target).Health && Items.HasItem(MountainId) && Items.CanUseItem(MountainId)
                && ((Obj_AI_Hero)args.Target).Distance(ObjectManager.Player.Position) < MountainRange && !((Obj_AI_Hero)args.Target).IsDead)
            {
                Items.UseItem(MountainId, ((Obj_AI_Hero)args.Target));
            }
            ...
            if (sender is Obj_AI_Hero && args.Target.IsAlly && args.Target.Type == GameObjectType.obj_AI_Hero
                ...
                && sender.IsEnemy && sender.GetSpellDamage(((Obj_AI_Hero)args.Target), args.SData.Name) > ((Obj_AI_Hero)args.Target).Health && Items.HasItem(MountainId) && Items.CanUseItem(MountainId)
                && ((Obj_AI_Hero)args.Target).Distance(ObjectManager.Player.Position) < MountainRange && !((Obj_AI_Hero)args.Target).IsDead && args.SData.TargettingType == SpellDataTargetType.Unit)
            {
                Items.UseItem(MountainId, ((Obj_AI_Hero)args.Target));
            }
            ...
            if (sender is Obj_AI_Hero && args.Target.IsAlly && args.Target.Type == GameObjectType.obj_AI_Hero
                ...
                && sender.IsEnemy && sender.GetSpellDamage(((Obj_AI_Hero)args.Target), args.SData.Name) > ((Obj_AI_Hero)args.Target).Health && Items.HasItem(SolariItemId) && Items.CanUseItem(SolariItemId)
                && ((Obj_AI_Hero)args.Target).Distance(ObjectManager.Player.Position) < SolariRange && !((Obj_AI_Hero)args.Target).IsDead)
            {
                Items.UseItem(SolariItemId, ((Obj_AI_Hero)args.Target));
            }
            ...
            if (sender is Obj_AI_Hero && args.Target.IsAlly && args.Target.Type == GameObjectType.obj_AI_Hero
                ...
                && sender.IsEnemy && sender.GetSpellDamage(((Obj_AI_Hero)args.Target), args.SData.Name) > ((Obj_AI_Hero)args.Target).Health && Items.HasItem(SolariItemId) && Items.CanUseItem(SolariItemId)
                && ((Obj_AI_Hero)args.Target).Distance(ObjectManager.Player.Position) < SolariRange && !((Obj_AI_Hero)args.Target).IsDead && args.SData.TargettingType == SpellDataTargetType.Unit)
            {
                Items.UseItem(SolariItemId, ((Obj_AI_Hero)args.Target));
            }
        }
